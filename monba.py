...
class Monba:
    ...
    def attack(self, enemy):
        ...
        enemy.life -= damage
        print(f"{enemy.name} pedeu {damage} de vida")
...
class MonbaAnimal(Monba):
    ...
    def attack(self, monba):
        print(f'{self.especie} arranhou {monba.especie}')
        return super().attack(monba)

class MonbaAnimed(Monba):

    def attack(self, monba):
        print(f'{self.especie} bateu {monba.especie}')
        return super().attack(monba)

class MonbaZombie(Monba):

    def attack(self, monba):
        print(f'{self.especie} mordeu {monba.especie}')
        return super().attack(monba)
